...
exec "Snippet {ass {assign var=".st.et." value=\"".st.et."\"}".st.et
exec "Snippet {for {foreach from=".st.et." item=i".st.et."}<CR>".st.et."<CR>{/foreach}<CR>".st.et
exec "Snippet {cap {capture assign=".st.et."}<CR>".st.et."<CR>{/capture}<CR>".st.et
...
exec "Snippet {inc {include file=\"".st.et."\"}".st.et
