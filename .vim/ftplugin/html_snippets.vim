...
exec "Snippet table <table ".st.et."><CR>".st.et."<CR></table>"
exec "Snippet tr <tr ".st.et."><CR>".st.et."<CR></tr>"
exec "Snippet td <td ".st.et."><CR>".st.et."<CR></td>"
...
exec "Snippet img <img src=\"".st.et."\"".st.et."/>".st.et
