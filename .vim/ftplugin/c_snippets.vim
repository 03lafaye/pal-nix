...
exec "Snippet for for( ".st.et." ".st."i".et." = ".st.et."; ".st."i".et." < ".st."count".et."; ".st.et.st."i".et." )<CR>{<CR>".st.et."<CR>}<CR>".st.et 
" for loop iterator
exec "Snippet ifor for( ".st.et." ".st."iter".et." = ".st.et."; ".st."iter".et." != ".st.et."; ++".st."iter".et." )<CR>{<CR>".st.et."<CR>}<CR>".st.et
